...
function resize(){   
    ...
    // wrapper.style.width = max?'':windowWidth * scale;
    // wrapper.style.height = max?'':windowHeight * scale;
}
...
// Handling the three Questions and putting their Answers //
...
// Helpful Function for handling the close button // 
...
// Helpful Function for handling the Overlay Model // 
...
// Handling the first two buttons at the top // 
...
// Handling the other two buttons at the buttom // 
button3.addEventListener('click', refresh);
button4.addEventListener('click', showAns);

// refresh fn: refreshes all the events in the Card //
function refresh(){
  ans1.innerHTML = "&nbsp;";
  ans2.innerHTML = "&nbsp;";
  ans3.innerHTML = "&nbsp;";
  ...
  // Re-adding events once again after removing them //
  choiceA.addEventListener('click', backColorA);
  choiceP.addEventListener('click', backColorP);
  ans1.addEventListener('click', putAnswer1);
  ans2.addEventListener('click', putAnswer2);
...
// showAns fn: shows answers and remove all events in the Card //
function showAns(){
...
function allDone(){
  ...
  // Removing events to stop waiting for any clicks //
